...
declare const DisablePolicyTypeCommand_base: {
    new (input: DisablePolicyTypeCommandInput): import("@smithy/core/client").CommandImpl<DisablePolicyTypeCommandInput, DisablePolicyTypeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisablePolicyTypeCommandInput): import("@smithy/core/client").CommandImpl<DisablePolicyTypeCommandInput, DisablePolicyTypeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
