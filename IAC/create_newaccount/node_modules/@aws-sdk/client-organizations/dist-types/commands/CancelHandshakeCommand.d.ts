...
declare const CancelHandshakeCommand_base: {
    new (input: CancelHandshakeCommandInput): import("@smithy/core/client").CommandImpl<CancelHandshakeCommandInput, CancelHandshakeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelHandshakeCommandInput): import("@smithy/core/client").CommandImpl<CancelHandshakeCommandInput, CancelHandshakeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
