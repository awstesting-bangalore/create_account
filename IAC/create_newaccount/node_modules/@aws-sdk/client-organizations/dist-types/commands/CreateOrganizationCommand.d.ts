...
declare const CreateOrganizationCommand_base: {
    new (input: CreateOrganizationCommandInput): import("@smithy/core/client").CommandImpl<CreateOrganizationCommandInput, CreateOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateOrganizationCommandInput]): import("@smithy/core/client").CommandImpl<CreateOrganizationCommandInput, CreateOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
