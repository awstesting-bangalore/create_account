...
declare const CreateOrganizationalUnitCommand_base: {
    new (input: CreateOrganizationalUnitCommandInput): import("@smithy/core/client").CommandImpl<CreateOrganizationalUnitCommandInput, CreateOrganizationalUnitCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateOrganizationalUnitCommandInput): import("@smithy/core/client").CommandImpl<CreateOrganizationalUnitCommandInput, CreateOrganizationalUnitCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
