...
declare const DeleteOrganizationalUnitCommand_base: {
    new (input: DeleteOrganizationalUnitCommandInput): import("@smithy/core/client").CommandImpl<DeleteOrganizationalUnitCommandInput, DeleteOrganizationalUnitCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteOrganizationalUnitCommandInput): import("@smithy/core/client").CommandImpl<DeleteOrganizationalUnitCommandInput, DeleteOrganizationalUnitCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
