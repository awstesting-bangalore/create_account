...
declare const ListDelegatedAdministratorsCommand_base: {
    new (input: ListDelegatedAdministratorsCommandInput): import("@smithy/core/client").CommandImpl<ListDelegatedAdministratorsCommandInput, ListDelegatedAdministratorsCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDelegatedAdministratorsCommandInput]): import("@smithy/core/client").CommandImpl<ListDelegatedAdministratorsCommandInput, ListDelegatedAdministratorsCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
