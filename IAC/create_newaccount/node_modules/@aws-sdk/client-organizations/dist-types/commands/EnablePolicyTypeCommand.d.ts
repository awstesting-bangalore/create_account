...
declare const EnablePolicyTypeCommand_base: {
    new (input: EnablePolicyTypeCommandInput): import("@smithy/core/client").CommandImpl<EnablePolicyTypeCommandInput, EnablePolicyTypeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnablePolicyTypeCommandInput): import("@smithy/core/client").CommandImpl<EnablePolicyTypeCommandInput, EnablePolicyTypeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
