...
declare const DescribeEffectivePolicyCommand_base: {
    new (input: DescribeEffectivePolicyCommandInput): import("@smithy/core/client").CommandImpl<DescribeEffectivePolicyCommandInput, DescribeEffectivePolicyCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeEffectivePolicyCommandInput): import("@smithy/core/client").CommandImpl<DescribeEffectivePolicyCommandInput, DescribeEffectivePolicyCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
