...
declare const ListAccountsCommand_base: {
    new (input: ListAccountsCommandInput): import("@smithy/core/client").CommandImpl<ListAccountsCommandInput, ListAccountsCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAccountsCommandInput]): import("@smithy/core/client").CommandImpl<ListAccountsCommandInput, ListAccountsCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
