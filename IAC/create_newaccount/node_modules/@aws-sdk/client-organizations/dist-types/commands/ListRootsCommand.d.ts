...
declare const ListRootsCommand_base: {
    new (input: ListRootsCommandInput): import("@smithy/core/client").CommandImpl<ListRootsCommandInput, ListRootsCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListRootsCommandInput]): import("@smithy/core/client").CommandImpl<ListRootsCommandInput, ListRootsCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
