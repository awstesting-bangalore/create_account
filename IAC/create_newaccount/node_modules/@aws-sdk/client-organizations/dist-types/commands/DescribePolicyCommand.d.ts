...
declare const DescribePolicyCommand_base: {
    new (input: DescribePolicyCommandInput): import("@smithy/core/client").CommandImpl<DescribePolicyCommandInput, DescribePolicyCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribePolicyCommandInput): import("@smithy/core/client").CommandImpl<DescribePolicyCommandInput, DescribePolicyCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
