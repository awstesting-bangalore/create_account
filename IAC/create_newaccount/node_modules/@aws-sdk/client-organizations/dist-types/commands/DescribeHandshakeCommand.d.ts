...
declare const DescribeHandshakeCommand_base: {
    new (input: DescribeHandshakeCommandInput): import("@smithy/core/client").CommandImpl<DescribeHandshakeCommandInput, DescribeHandshakeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeHandshakeCommandInput): import("@smithy/core/client").CommandImpl<DescribeHandshakeCommandInput, DescribeHandshakeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
