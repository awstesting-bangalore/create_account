...
declare const DeclineHandshakeCommand_base: {
    new (input: DeclineHandshakeCommandInput): import("@smithy/core/client").CommandImpl<DeclineHandshakeCommandInput, DeclineHandshakeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeclineHandshakeCommandInput): import("@smithy/core/client").CommandImpl<DeclineHandshakeCommandInput, DeclineHandshakeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
