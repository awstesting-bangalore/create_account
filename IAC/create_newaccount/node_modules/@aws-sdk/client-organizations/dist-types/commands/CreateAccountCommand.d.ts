...
declare const CreateAccountCommand_base: {
    new (input: CreateAccountCommandInput): import("@smithy/core/client").CommandImpl<CreateAccountCommandInput, CreateAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAccountCommandInput): import("@smithy/core/client").CommandImpl<CreateAccountCommandInput, CreateAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
