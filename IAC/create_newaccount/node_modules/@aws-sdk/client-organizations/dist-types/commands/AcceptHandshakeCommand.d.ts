...
declare const AcceptHandshakeCommand_base: {
    new (input: AcceptHandshakeCommandInput): import("@smithy/core/client").CommandImpl<AcceptHandshakeCommandInput, AcceptHandshakeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptHandshakeCommandInput): import("@smithy/core/client").CommandImpl<AcceptHandshakeCommandInput, AcceptHandshakeCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
