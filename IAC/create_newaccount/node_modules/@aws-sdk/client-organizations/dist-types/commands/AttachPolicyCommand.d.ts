...
declare const AttachPolicyCommand_base: {
    new (input: AttachPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachPolicyCommandInput, AttachPolicyCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachPolicyCommandInput, AttachPolicyCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
