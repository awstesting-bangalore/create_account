...
declare const UpdateResponsibilityTransferCommand_base: {
    new (input: UpdateResponsibilityTransferCommandInput): import("@smithy/core/client").CommandImpl<UpdateResponsibilityTransferCommandInput, UpdateResponsibilityTransferCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateResponsibilityTransferCommandInput): import("@smithy/core/client").CommandImpl<UpdateResponsibilityTransferCommandInput, UpdateResponsibilityTransferCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
