...
declare const LeaveOrganizationCommand_base: {
    new (input: LeaveOrganizationCommandInput): import("@smithy/core/client").CommandImpl<LeaveOrganizationCommandInput, LeaveOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [LeaveOrganizationCommandInput]): import("@smithy/core/client").CommandImpl<LeaveOrganizationCommandInput, LeaveOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
