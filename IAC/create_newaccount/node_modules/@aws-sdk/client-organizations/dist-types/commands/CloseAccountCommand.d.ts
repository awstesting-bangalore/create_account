...
declare const CloseAccountCommand_base: {
    new (input: CloseAccountCommandInput): import("@smithy/core/client").CommandImpl<CloseAccountCommandInput, CloseAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CloseAccountCommandInput): import("@smithy/core/client").CommandImpl<CloseAccountCommandInput, CloseAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
