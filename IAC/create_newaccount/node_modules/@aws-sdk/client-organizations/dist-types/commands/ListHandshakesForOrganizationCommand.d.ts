...
declare const ListHandshakesForOrganizationCommand_base: {
    new (input: ListHandshakesForOrganizationCommandInput): import("@smithy/core/client").CommandImpl<ListHandshakesForOrganizationCommandInput, ListHandshakesForOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListHandshakesForOrganizationCommandInput]): import("@smithy/core/client").CommandImpl<ListHandshakesForOrganizationCommandInput, ListHandshakesForOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
