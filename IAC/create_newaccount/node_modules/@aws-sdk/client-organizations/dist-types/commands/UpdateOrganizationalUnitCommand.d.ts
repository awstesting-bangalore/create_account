...
declare const UpdateOrganizationalUnitCommand_base: {
    new (input: UpdateOrganizationalUnitCommandInput): import("@smithy/core/client").CommandImpl<UpdateOrganizationalUnitCommandInput, UpdateOrganizationalUnitCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateOrganizationalUnitCommandInput): import("@smithy/core/client").CommandImpl<UpdateOrganizationalUnitCommandInput, UpdateOrganizationalUnitCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
