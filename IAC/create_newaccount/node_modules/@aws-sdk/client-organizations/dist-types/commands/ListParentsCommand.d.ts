...
declare const ListParentsCommand_base: {
    new (input: ListParentsCommandInput): import("@smithy/core/client").CommandImpl<ListParentsCommandInput, ListParentsCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListParentsCommandInput): import("@smithy/core/client").CommandImpl<ListParentsCommandInput, ListParentsCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
