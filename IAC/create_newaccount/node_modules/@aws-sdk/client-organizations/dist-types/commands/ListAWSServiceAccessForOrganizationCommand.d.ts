...
declare const ListAWSServiceAccessForOrganizationCommand_base: {
    new (input: ListAWSServiceAccessForOrganizationCommandInput): import("@smithy/core/client").CommandImpl<ListAWSServiceAccessForOrganizationCommandInput, ListAWSServiceAccessForOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAWSServiceAccessForOrganizationCommandInput]): import("@smithy/core/client").CommandImpl<ListAWSServiceAccessForOrganizationCommandInput, ListAWSServiceAccessForOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
