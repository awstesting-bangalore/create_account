...
declare const DetachPolicyCommand_base: {
    new (input: DetachPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachPolicyCommandInput, DetachPolicyCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachPolicyCommandInput, DetachPolicyCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
