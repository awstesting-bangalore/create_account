...
declare const ListPoliciesForTargetCommand_base: {
    new (input: ListPoliciesForTargetCommandInput): import("@smithy/core/client").CommandImpl<ListPoliciesForTargetCommandInput, ListPoliciesForTargetCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPoliciesForTargetCommandInput): import("@smithy/core/client").CommandImpl<ListPoliciesForTargetCommandInput, ListPoliciesForTargetCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
