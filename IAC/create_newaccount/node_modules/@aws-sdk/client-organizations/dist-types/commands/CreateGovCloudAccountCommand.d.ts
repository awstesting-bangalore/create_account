...
declare const CreateGovCloudAccountCommand_base: {
    new (input: CreateGovCloudAccountCommandInput): import("@smithy/core/client").CommandImpl<CreateGovCloudAccountCommandInput, CreateGovCloudAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateGovCloudAccountCommandInput): import("@smithy/core/client").CommandImpl<CreateGovCloudAccountCommandInput, CreateGovCloudAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
