...
declare const EnableAllFeaturesCommand_base: {
    new (input: EnableAllFeaturesCommandInput): import("@smithy/core/client").CommandImpl<EnableAllFeaturesCommandInput, EnableAllFeaturesCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableAllFeaturesCommandInput]): import("@smithy/core/client").CommandImpl<EnableAllFeaturesCommandInput, EnableAllFeaturesCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
