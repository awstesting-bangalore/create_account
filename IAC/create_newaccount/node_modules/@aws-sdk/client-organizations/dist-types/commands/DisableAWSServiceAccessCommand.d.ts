...
declare const DisableAWSServiceAccessCommand_base: {
    new (input: DisableAWSServiceAccessCommandInput): import("@smithy/core/client").CommandImpl<DisableAWSServiceAccessCommandInput, DisableAWSServiceAccessCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableAWSServiceAccessCommandInput): import("@smithy/core/client").CommandImpl<DisableAWSServiceAccessCommandInput, DisableAWSServiceAccessCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
