...
declare const DescribeCreateAccountStatusCommand_base: {
    new (input: DescribeCreateAccountStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeCreateAccountStatusCommandInput, DescribeCreateAccountStatusCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCreateAccountStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeCreateAccountStatusCommandInput, DescribeCreateAccountStatusCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
