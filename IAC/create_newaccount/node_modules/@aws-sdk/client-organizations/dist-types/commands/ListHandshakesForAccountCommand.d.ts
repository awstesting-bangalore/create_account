...
declare const ListHandshakesForAccountCommand_base: {
    new (input: ListHandshakesForAccountCommandInput): import("@smithy/core/client").CommandImpl<ListHandshakesForAccountCommandInput, ListHandshakesForAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListHandshakesForAccountCommandInput]): import("@smithy/core/client").CommandImpl<ListHandshakesForAccountCommandInput, ListHandshakesForAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
