...
declare const DescribeOrganizationalUnitCommand_base: {
    new (input: DescribeOrganizationalUnitCommandInput): import("@smithy/core/client").CommandImpl<DescribeOrganizationalUnitCommandInput, DescribeOrganizationalUnitCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeOrganizationalUnitCommandInput): import("@smithy/core/client").CommandImpl<DescribeOrganizationalUnitCommandInput, DescribeOrganizationalUnitCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
