...
declare const DescribeAccountCommand_base: {
    new (input: DescribeAccountCommandInput): import("@smithy/core/client").CommandImpl<DescribeAccountCommandInput, DescribeAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAccountCommandInput): import("@smithy/core/client").CommandImpl<DescribeAccountCommandInput, DescribeAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
