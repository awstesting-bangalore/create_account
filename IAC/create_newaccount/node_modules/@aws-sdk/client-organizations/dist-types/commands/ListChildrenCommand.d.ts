...
declare const ListChildrenCommand_base: {
    new (input: ListChildrenCommandInput): import("@smithy/core/client").CommandImpl<ListChildrenCommandInput, ListChildrenCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListChildrenCommandInput): import("@smithy/core/client").CommandImpl<ListChildrenCommandInput, ListChildrenCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
