...
declare const DeleteOrganizationCommand_base: {
    new (input: DeleteOrganizationCommandInput): import("@smithy/core/client").CommandImpl<DeleteOrganizationCommandInput, DeleteOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteOrganizationCommandInput]): import("@smithy/core/client").CommandImpl<DeleteOrganizationCommandInput, DeleteOrganizationCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
