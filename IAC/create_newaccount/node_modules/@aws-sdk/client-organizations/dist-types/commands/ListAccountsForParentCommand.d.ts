...
declare const ListAccountsForParentCommand_base: {
    new (input: ListAccountsForParentCommandInput): import("@smithy/core/client").CommandImpl<ListAccountsForParentCommandInput, ListAccountsForParentCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAccountsForParentCommandInput): import("@smithy/core/client").CommandImpl<ListAccountsForParentCommandInput, ListAccountsForParentCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
