...
declare const ListCreateAccountStatusCommand_base: {
    new (input: ListCreateAccountStatusCommandInput): import("@smithy/core/client").CommandImpl<ListCreateAccountStatusCommandInput, ListCreateAccountStatusCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCreateAccountStatusCommandInput]): import("@smithy/core/client").CommandImpl<ListCreateAccountStatusCommandInput, ListCreateAccountStatusCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
