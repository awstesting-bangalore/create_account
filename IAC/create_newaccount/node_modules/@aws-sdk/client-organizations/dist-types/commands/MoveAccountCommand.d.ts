...
declare const MoveAccountCommand_base: {
    new (input: MoveAccountCommandInput): import("@smithy/core/client").CommandImpl<MoveAccountCommandInput, MoveAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: MoveAccountCommandInput): import("@smithy/core/client").CommandImpl<MoveAccountCommandInput, MoveAccountCommandOutput, import("..").OrganizationsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
