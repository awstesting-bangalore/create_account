...
export declare const ConstraintViolationExceptionReason: {
    ...
    readonly ACCOUNT_NOT_ACTIVE_FOR_TRANSFER_RESPONSIBILITY: "ACCOUNT_NOT_ACTIVE_FOR_TRANSFER_RESPONSIBILITY";
    ...
    readonly TRANSFER_RESPONSIBILITY_UPDATE_NOT_ALLOWED: "TRANSFER_RESPONSIBILITY_UPDATE_NOT_ALLOWED";
    readonly UNMET_BILLING_PREREQUISITE: "UNMET_BILLING_PREREQUISITE";
...
export declare const HandshakeConstraintViolationExceptionReason: {
    ...
    readonly PAST_DUE_INVOICE: "PAST_DUE_INVOICE";
    ...
    readonly TARGET_ACCOUNT_VALIDATION_FAILURE: "TARGET_ACCOUNT_VALIDATION_FAILURE";
...
export declare const InvalidInputExceptionReason: {
    ...
    readonly END_DATE_TOO_LATE: "END_DATE_TOO_LATE";
