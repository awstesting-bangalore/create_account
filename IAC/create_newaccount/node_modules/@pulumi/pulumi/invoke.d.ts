 ...
 */
export declare function invokeOptionsFromResourceOptions(opts: ResourceOptions): InvokeOptions;
/**
 ...
 * are dropped.
 */
export declare function invokeOutputOptionsFromResourceOptions(opts: ResourceOptions): InvokeOutputOptions;
/**
