...
export declare class AnomalyDetector extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AnomalyDetectorState, opts?: pulumi.CustomResourceOptions): AnomalyDetector;
    /**
     ...
     */
    readonly configuration: pulumi.Output<outputs.amp.AnomalyDetectorConfiguration>;
    /**
     ...
     */
    readonly evaluationIntervalInSeconds: pulumi.Output<number>;
    /**
     ...
     */
    readonly missingDataAction: pulumi.Output<outputs.amp.AnomalyDetectorMissingDataAction>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.amp.AnomalyDetectorTimeouts | undefined>;
    /**
