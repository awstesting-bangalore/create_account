...
export declare class Connection extends pulumi.CustomResource {
     ...
     */
    readonly rateLimiterStatuses: pulumi.Output<outputs.directconnect.ConnectionRateLimiterStatus[]>;
    /**
