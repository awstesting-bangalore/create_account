...
export declare class Cluster extends pulumi.CustomResource {
     ...
     */
    readonly kubeApiServerConfig: pulumi.Output<outputs.eks.ClusterKubeApiServerConfig>;
    /**
     * Configuration block for customizing the Kubernetes controller manager. Detailed below.
     */
    readonly kubeControllerManagerConfig: pulumi.Output<outputs.eks.ClusterKubeControllerManagerConfig>;
    /**
     * Configuration block for customizing the Kubernetes scheduler. Detailed below.
     */
    readonly kubeSchedulerConfig: pulumi.Output<outputs.eks.ClusterKubeSchedulerConfig>;
    /**
