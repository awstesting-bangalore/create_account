...
export declare const IndexingRule: typeof import("./indexingRule").IndexingRule;
...
export declare const TraceSegmentDestination: typeof import("./traceSegmentDestination").TraceSegmentDestination;
