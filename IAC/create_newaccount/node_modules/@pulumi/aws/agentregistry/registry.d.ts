...
export declare class Registry extends pulumi.CustomResource {
     ...
     */
    readonly autoDetectionConfiguration: pulumi.Output<outputs.agentregistry.RegistryAutoDetectionConfiguration | undefined>;
    /**
     ...
     */
    readonly discoveryConfiguration: pulumi.Output<outputs.agentregistry.RegistryDiscoveryConfiguration>;
    /**
     * Server-side encryption configuration for the registry. See below.
     */
    readonly encryptionConfiguration: pulumi.Output<outputs.agentregistry.RegistryEncryptionConfiguration | undefined>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.agentregistry.RegistryTimeouts | undefined>;
    /**
