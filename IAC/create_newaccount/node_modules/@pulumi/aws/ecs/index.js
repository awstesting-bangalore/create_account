...
exports.DaemonTaskDefinition = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:ecs/daemon:Daemon":
                return new exports.Daemon(name, undefined, { urn });
            case "aws:ecs/daemonTaskDefinition:DaemonTaskDefinition":
                return new exports.DaemonTaskDefinition(name, undefined, { urn });
