    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:networkfirewall/containerAssociation:ContainerAssociation":
                return new exports.ContainerAssociation(name, undefined, { urn });
