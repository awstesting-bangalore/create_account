...
exports.ResourcePolicy = exports.PipelineEndpoint = exports.Pipeline = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../utilities"));
exports.Pipeline = null;
utilities.lazyLoad(exports, ["Pipeline"], () => require("./pipeline"));
exports.PipelineEndpoint = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:opensearchingest/pipelineEndpoint:PipelineEndpoint":
                return new exports.PipelineEndpoint(name, undefined, { urn });
