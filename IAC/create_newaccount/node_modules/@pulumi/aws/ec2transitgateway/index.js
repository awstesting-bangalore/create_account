    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:ec2transitgateway/policyTableEntry:PolicyTableEntry":
                return new exports.PolicyTableEntry(name, undefined, { urn });
