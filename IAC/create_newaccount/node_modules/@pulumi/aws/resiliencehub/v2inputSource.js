...
class V2InputSource extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new V2InputSource(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:resiliencehub/v2InputSource:V2InputSource';
    /**
...
exports.V2InputSource = V2InputSource;
//# sourceMappingURL=v2inputSource.js.map