...
class V2Assertion extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new V2Assertion(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:resiliencehub/v2Assertion:V2Assertion';
    /**
...
exports.V2Assertion = V2Assertion;
//# sourceMappingURL=v2assertion.js.map