 ...
 * ```
 */
export declare class V2Service extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V2ServiceState, opts?: pulumi.CustomResourceOptions): V2Service;
    /**
     * Returns true if the given object is an instance of V2Service.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is V2Service;
    /**
     * ARN of the service.
     */
     ...
     */
    readonly associatedSystems: pulumi.Output<outputs.resiliencehub.V2ServiceAssociatedSystem[] | undefined>;
    /**
     * Dependency discovery. Valid values: `ENABLED`, `DISABLED`.
     */
    readonly dependencyDiscovery: pulumi.Output<string>;
    /**
     ...
     */
    readonly permissionModel: pulumi.Output<outputs.resiliencehub.V2ServicePermissionModel>;
    /**
...
//# sourceMappingURL=v2service.d.ts.map