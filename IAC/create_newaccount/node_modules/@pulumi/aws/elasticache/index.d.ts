...
export declare const getServiceUpdateActions: typeof import("./getServiceUpdateActions").getServiceUpdateActions;
export declare const getServiceUpdateActionsOutput: typeof import("./getServiceUpdateActions").getServiceUpdateActionsOutput;
export { GetServiceUpdatesArgs, GetServiceUpdatesResult, GetServiceUpdatesOutputArgs } from "./getServiceUpdates";
export declare const getServiceUpdates: typeof import("./getServiceUpdates").getServiceUpdates;
export declare const getServiceUpdatesOutput: typeof import("./getServiceUpdates").getServiceUpdatesOutput;
