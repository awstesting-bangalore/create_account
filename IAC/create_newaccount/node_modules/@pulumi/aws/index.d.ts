export declare const arnBuild: typeof import("./arnBuild").arnBuild;
export declare const arnBuildOutput: typeof import("./arnBuild").arnBuildOutput;
export { ArnParseResult } from "./arnParse";
export declare const arnParse: typeof import("./arnParse").arnParse;
export declare const arnParseOutput: typeof import("./arnParse").arnParseOutput;
...
export * from "./tags";
export declare const trimIamRolePath: typeof import("./trimIamRolePath").trimIamRolePath;
export declare const trimIamRolePathOutput: typeof import("./trimIamRolePath").trimIamRolePathOutput;
export declare const userAgent: typeof import("./userAgent").userAgent;
export declare const userAgentOutput: typeof import("./userAgent").userAgentOutput;
export * from "./utils";
