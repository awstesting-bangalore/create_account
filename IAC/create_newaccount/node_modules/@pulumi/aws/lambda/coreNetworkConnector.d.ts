 ...
 * ```
 */
export declare class CoreNetworkConnector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CoreNetworkConnectorState, opts?: pulumi.CustomResourceOptions): CoreNetworkConnector;
    /**
     * Returns true if the given object is an instance of CoreNetworkConnector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CoreNetworkConnector;
    /**
     ...
     */
    readonly configuration: pulumi.Output<outputs.lambda.CoreNetworkConnectorConfiguration>;
    /**
     ...
     */
    readonly operatorRole: pulumi.Output<string>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
    readonly region: pulumi.Output<string>;
    readonly timeouts: pulumi.Output<outputs.lambda.CoreNetworkConnectorTimeouts | undefined>;
    /**
...
//# sourceMappingURL=coreNetworkConnector.d.ts.map