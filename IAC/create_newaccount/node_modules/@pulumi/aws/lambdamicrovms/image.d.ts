...
export declare class Image extends pulumi.CustomResource {
     ...
     */
    readonly additionalOsCapabilities: pulumi.Output<string[] | undefined>;
    /**
     * ARN of the Image.
     */
     ...
     */
    readonly codeArtifact: pulumi.Output<outputs.lambdamicrovms.ImageCodeArtifact>;
    /**
     * CPU configuration for the MicroVM. See `cpuConfiguration` Block below.
     */
    readonly cpuConfigurations: pulumi.Output<outputs.lambdamicrovms.ImageCpuConfiguration[] | undefined>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.lambdamicrovms.ImageTimeouts | undefined>;
    /**
...
export interface ImageState {
     ...
     * Code artifact containing the application code and metadata for the image. See below.
     */
    codeArtifact?: pulumi.Input<inputs.lambdamicrovms.ImageCodeArtifact | undefined>;
    /**
     * CPU configuration for the MicroVM. See `cpuConfiguration` Block below.
     */
    cpuConfigurations?: pulumi.Input<pulumi.Input<inputs.lambdamicrovms.ImageCpuConfiguration>[] | undefined>;
    /**
     * RFC3339 timestamp when the image was created.
     */
    ...
    timeouts?: pulumi.Input<inputs.lambdamicrovms.ImageTimeouts | undefined>;
    /**
     * RFC3339 timestamp when the image was last updated.
     */
...
export interface ImageArgs {
     ...
     * Code artifact containing the application code and metadata for the image. See below.
     */
    codeArtifact: pulumi.Input<inputs.lambdamicrovms.ImageCodeArtifact>;
    /**
     * CPU configuration for the MicroVM. See `cpuConfiguration` Block below.
     */
    cpuConfigurations?: pulumi.Input<pulumi.Input<inputs.lambdamicrovms.ImageCpuConfiguration>[] | undefined>;
